...
parser.add_argument('--save_path', default='./baseline/trigger_set/initial', type=str)
...
parser.add_argument("-dt", "--dataset",type=str,default='mnist',choices=['cifar10', 'cifar100', 'svhn', 'mnist'])
...
def train(args, trainloader , valloader, device):
    ...
    logging.basicConfig(
            ...
            level=logging.DEBUG,
            handlers=[
                logging.FileHandler(os.path.join(args.save_path, args.ver, 'output.log')),
...
if __name__ == "__main__":
    ...
    # ************************** set log **************************
    logger_file = os.path.join(args.save_path + '/' + args.ver, 'margined_based_watermark.log')
